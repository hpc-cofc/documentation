...
* [Run Calculations](using-the-hpc/scheduling-jobs/README.md)
  ...
  * [Examples @GitHub](using-the-hpc/scheduling-jobs/examples-github/README.md)
    * [AMBER](using-the-hpc/scheduling-jobs/examples-github/amber.md)
    * [CM1](using-the-hpc/scheduling-jobs/examples-github/cm1.md)
    * [GAMESS](using-the-hpc/scheduling-jobs/examples-github/gamess.md)
    * [Gaussian](using-the-hpc/scheduling-jobs/examples-github/gaussian.md)
    * [GPUs \(cuda\)](using-the-hpc/scheduling-jobs/examples-github/gpus-cuda.md)
    * [NAMD](using-the-hpc/scheduling-jobs/examples-github/namd.md)
    * [Mathematica](using-the-hpc/scheduling-jobs/examples-github/mathematica.md)
...
* [Git Version Control](misc/git-basics/README.md)
  * [Git and Atom: GitLab](misc/git-basics/git-workflow-gitlab.md)
  * [Git and Atom: GitHub](misc/git-basics/git-workflow-github.md)
  * [Git in the Command Line](misc/git-basics/git-command-line.md)
  * [Git Scenarios](misc/git-basics/git-scenarios.md)
* [Contributing to docs](misc/contributing/README.md)
